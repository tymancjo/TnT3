...
EG_F2_100_TPS = tntO.thermalElement(
        # shape(width, height, length, number of bars in parrallel, pointing angle {0->right, 90->top, 180->left, 270-> down})
        shape = tntO.shape(20,100,200,1,-90), 
        HTC = 24,
        emissivity = 0.35,
...
VBB_F1T_1k6 = tntO.thermalElement(
        # shape(width, height, length, number of bars in parrallel, pointing angle {0->right, 90->top, 180->left, 270-> down})
        shape = tntO.shape(10,30,1000,3,-90), 
        HTC = 4,
        emissivity = 0.35,
        dP = True,
        source = 0,
...
VBB_F1T_1k = tntO.thermalElement(
        # shape(width, height, length, number of bars in parrallel, pointing angle {0->right, 90->top, 180->left, 270-> down})
...
# some elements for DC systems

DC_3x100 = tntO.thermalElement(
        # shape(width, height, length, number of bars in parrallel, pointing angle {0->right, 90->top, 180->left, 270-> down})
        shape = tntO.shape(10,100,1000,3,0), 
        HTC = 3.0,
        emissivity = 0.35,
        dP = True,
        source = 0,
...
DC_2x100 = tntO.thermalElement(
        # shape(width, height, length, number of bars in parrallel, pointing angle {0->right, 90->top, 180->left, 270-> down})
        shape = tntO.shape(10,100,1000,2,0), 
        HTC = 3.0,
        emissivity = 0.35,
        dP = True,
        source = 0,
...
DC_Conn = tntO.thermalElement(
        # shape(width, height, length, number of bars in parrallel, pointing angle {0->right, 90->top, 180->left, 270-> down})
        shape = tntO.shape(60,100,1000,1,0), 
        HTC = 3.0,
        emissivity = 0.35,
        dP = True,
        source = 0,
